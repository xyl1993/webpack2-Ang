export default ['$scope', '$state', '$http', 'APPBASE', '$compile', 'workFlowServ',
    function ($scope, $state, $http, APPBASE, $compile, workFlowServ) {
        ...
        $scope.approvalFormData = {};    //form表单model
        ...
        $scope.uploadFile = function(event){
            ...
            var fileInput = $('#approvalUploadFileInput');
        ...
        $scope.submit = function(){
            let formData = $scope.approvalFormData;
            ...
            workFlowServ.saveFormApproval($http,APPBASE,formData).then(function(res){
                if(res.data.code === 0){
        ...
        $scope.dialogSureClick = function(){
            $state.reload('main.workFlow.approval');
