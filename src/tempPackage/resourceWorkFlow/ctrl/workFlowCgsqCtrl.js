export default ['$scope', '$state','$http', 'APPBASE', '$compile', 'workFlowServ',
    function ($scope, $state, $http, APPBASE, $compile, workFlowServ) {
        ...
        $scope.CgsqFormData = {};    //form表单model
        ...
        $scope.uploadFile = function(event){
            ...
            var fileInput = $('#cgsqUploadFileInput');
        ...
        $scope.submit = function(){
            let formData = $scope.cgsqFormData;
            ...
            workFlowServ.saveFormCgsq($http,APPBASE,formData).then(function(res){
                if(res.data.code === 0){
        ...
        $scope.dialogSureClick = function(){
            $state.reload('main.workFlow.cgsq');
