export default ['$scope', '$state', '$http', 'APPBASE', '$compile', 'workFlowServ',
    function ($scope, $state, $http, APPBASE, $compile, workFlowServ) {
        ...
        $scope.bgyplyFormData = {};    //form表单model
        ...
        $scope.uploadFile = function(event){
            ...
            var fileInput = $('#bgyplyUploadFileInput');
        ...
        $scope.submit = function(){
            let formData = $scope.bgyplyFormData;
            ...
            workFlowServ.saveFormBgyply($http,APPBASE,formData).then(function(res){
                if(res.data.code === 0){
        ...
        $scope.dialogSureClick = function(){
            $state.reload('main.workFlow.bgyply');
